...
if "%c%"=="" exit /b
if "%c%"=="1" (
    rem Отключаем акселерацию (Thresholds и Speed на 0) и ставим чувствительность 10 (соответствует 6/11)
...
if "%c%"=="0" (
    rem Возвращаем стандартную акселерацию Windows (6, 10, 1) и стандартную скорость 10 (6/11)
