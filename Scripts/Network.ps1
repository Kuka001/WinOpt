...
Write-Host "[2/5] ��������� NDIS..." -ForegroundColor Yellow
...
Write-Host "[3/5] ��������� ������� (���������� ����������� ����)..." -ForegroundColor Yellow
...
# �������� � ������������� ����� ���������� ��������� (Ethernet + Wi-Fi) �� ������� ����� Characteristics
...
# ������ � ����������
"*InterruptModeration"="1" # "1" ���������� ��� ������������ ������ � ������� (FPS).
"*JumboPacket"="1514";"*HeaderDataSplit"="1"
"*ReceiveBuffers"="1024" # 1024-2048 ������� Bufferbloat (�������� ��� ������� ������).
...
if($found -eq 0){Write-Host "�������� �� �������." -ForegroundColor Red}
else{Write-Host "�������������� ���������: $found" -ForegroundColor Green}

Write-Host "[5/5] ��������� TCP/IP (���������� ��������� ������)..." -ForegroundColor Yellow
