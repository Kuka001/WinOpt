...
- **Кодировка .ps1 файлов:** Скрипты могут быть как CRLF, так и LF. Однако, **если файл содержит кириллицу (русский текст), он ОБЯЗАТЕЛЬНО должен быть сохранен в кодировке UTF-8 с BOM** (UTF-8 with BOM). В противном случае стандартный Windows PowerShell 5.1 считывает его в системной ANSI-кодировке (Windows-1251), что приводит к искажению кириллицы («каракулям») и критическим синтаксическим ошибкам парсинга. Без кириллицы файлы могут сохраняться и без BOM.
